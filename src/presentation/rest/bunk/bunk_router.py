...
from src.domain.bunk.schema import AllBunks, BunkStatus, BunkResponseForPost, BunkResponse
...
async def add_bunk(
	...
	return await bunk_service.add_bunk_service(bunk_number, dispensary_id, room_number)


@bunk_router.get("/bunk_number/dispensary_id/room_number", response_model=BunkResponse, status_code=status.HTTP_200_OK)
